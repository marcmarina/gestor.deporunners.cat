...
export default function PrivacyScreen() {
  return (
    <Container>
      ...
      <p>
        El presente Política de Privacidad establece los términos en que Club
        Esportiu Deporunners usa y protege la información que es proporcionada
      ...
      <p>
        Club Esportiu Deporunners está altamente comprometido para cumplir con
        el compromiso de mantener su información segura. Usamos los sistemas más
      ...
      <p>
        Club Esportiu Deporunners Se reserva el derecho de cambiar los términos
